package com.deayea.contentprovidertest.provider;
...
import com.deayea.contentprovidertest.utils.DBOpenHelper;
...
public class NameContentProvider extends ContentProvider {
    ...
    static {
        matcher.addURI("com.deayea.contentprovidertest.providers.myprovider","test",1);
    }
