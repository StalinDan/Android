...
//    protected RelativeLayout.LayoutParams mKeyboardContainerLayoutParams;
    ...
    public KeyboardManager(Context context) {
        ...
        if (mContext instanceof Activity) {
            ...
            mKeyboardContainerLayoutParams = new FrameLayout.LayoutParams(600, ViewGroup
                    .LayoutParams.WRAP_CONTENT);
            mKeyboardContainerLayoutParams.gravity = Gravity.CENTER;

//            mKeyboardContainerLayoutParams = new RelativeLayout.LayoutParams(mRootView.getLayoutParams());
//            mKeyboardContainerLayoutParams.addRule(RelativeLayout.ALIGN_PARENT_RIGHT,RelativeLayout.TRUE);
//            mKeyboardContainerLayoutParams.addRule(RelativeLayout.CENTER_HORIZONTAL,RelativeLayout.TRUE);
//            mRootView.setLayoutParams(mKeyboardContainerLayoutParams);
