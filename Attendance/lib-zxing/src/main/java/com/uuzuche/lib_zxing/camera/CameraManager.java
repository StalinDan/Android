...
//      }
    ...
    public Rect getFramingRect() {
        try {
            ...
            // }
//            Log.i("aa","=======leftOffset-->"+leftOffset + "topOffset-->"+topOffset + "FRAME_WIDTH-->"+FRAME_WIDTH + "FRAME_HEIGHT-->"+FRAME_HEIGHT + "screenResolution.y-->"+screenResolution.y);
            return framingRect;
        } catch (Exception e) {
            e.printStackTrace();
            return null;
