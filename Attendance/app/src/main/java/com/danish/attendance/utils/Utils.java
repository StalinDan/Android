...
public class Utils {
    ...
    public static int getSceenWidth() {
        return AttendanceApplication.getContext().getResources().getDisplayMetrics().widthPixels;
    }
    ...
    public static int getSceenHeight() {
        return AttendanceApplication.getContext().getResources().getDisplayMetrics().heightPixels;
    }
    ...
    public static int dip2px(float dipValue) {
        float scale = AttendanceApplication.getContext().getResources().getDisplayMetrics().density;
    ...
    public static int px2dip(int pxValue) {
        float reSize = AttendanceApplication.getContext().getResources().getDisplayMetrics().density;
    ...
    public static float sp2px(int spValue) {
        return TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, spValue, AttendanceApplication.getContext().getResources().getDisplayMetrics());
    }
    ...
    private static PackageManager getPackageInfo() {
        return AttendanceApplication.getContext().getPackageManager();
    }
    ...
    public static String getPackageName() {
        return AttendanceApplication.getContext().getPackageName();
    }
